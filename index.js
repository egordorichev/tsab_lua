...
STATICTOP = STATIC_BASE + 165520;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_tsab_cpp() } }, { func: function() { ___emscripten_environ_constructor() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
// {{PRE_LIBRARY}}
  ...
  function _GPU_ActivateShaderProgram() {
  err('missing function: GPU_ActivateShaderProgram'); abort(-1);
  }

  function _GPU_BlitTransformX() {
  err('missing function: GPU_BlitTransformX'); abort(-1);
  }

  function _GPU_Circle() {
  err('missing function: GPU_Circle'); abort(-1);
  }

  function _GPU_CircleFilled() {
  err('missing function: GPU_CircleFilled'); abort(-1);
  }

  function _GPU_ClearRGB() {
  err('missing function: GPU_ClearRGB'); abort(-1);
  }

  function _GPU_CopyImageFromSurface() {
  err('missing function: GPU_CopyImageFromSurface'); abort(-1);
  }

  function _GPU_CreateImage() {
  err('missing function: GPU_CreateImage'); abort(-1);
  }

  function _GPU_Ellipse() {
  err('missing function: GPU_Ellipse'); abort(-1);
  }

  function _GPU_EllipseFilled() {
  err('missing function: GPU_EllipseFilled'); abort(-1);
  }

  function _GPU_Flip() {
  err('missing function: GPU_Flip'); abort(-1);
  }

  function _GPU_FreeImage() {
  err('missing function: GPU_FreeImage'); abort(-1);
  }

  function _GPU_FreeShader() {
  err('missing function: GPU_FreeShader'); abort(-1);
  }

  function _GPU_FreeShaderProgram() {
  err('missing function: GPU_FreeShaderProgram'); abort(-1);
  }

  function _GPU_GetShaderMessage() {
  err('missing function: GPU_GetShaderMessage'); abort(-1);
  }

  function _GPU_GetUniformLocation() {
  err('missing function: GPU_GetUniformLocation'); abort(-1);
  }

  function _GPU_Init() {
  err('missing function: GPU_Init'); abort(-1);
  }

  function _GPU_Line() {
  err('missing function: GPU_Line'); abort(-1);
  }

  function _GPU_LinkShaders() {
  err('missing function: GPU_LinkShaders'); abort(-1);
  }

  function _GPU_LoadShader() {
  err('missing function: GPU_LoadShader'); abort(-1);
  }

  function _GPU_LoadShaderBlock() {
  err('missing function: GPU_LoadShaderBlock'); abort(-1);
  }

  function _GPU_LoadTarget() {
  err('missing function: GPU_LoadTarget'); abort(-1);
  }

  function _GPU_LogError() {
  err('missing function: GPU_LogError'); abort(-1);
  }

  function _GPU_MakeRect() {
  err('missing function: GPU_MakeRect'); abort(-1);
  }

  function _GPU_MatrixMode() {
  err('missing function: GPU_MatrixMode'); abort(-1);
  }

  function _GPU_Pixel() {
  err('missing function: GPU_Pixel'); abort(-1);
  }

  function _GPU_PopMatrix() {
  err('missing function: GPU_PopMatrix'); abort(-1);
  }

  function _GPU_PushMatrix() {
  err('missing function: GPU_PushMatrix'); abort(-1);
  }

  function _GPU_Quit() {
  err('missing function: GPU_Quit'); abort(-1);
  }

  function _GPU_Rectangle() {
  err('missing function: GPU_Rectangle'); abort(-1);
  }

  function _GPU_RectangleFilled() {
  err('missing function: GPU_RectangleFilled'); abort(-1);
  }

  function _GPU_Scale() {
  err('missing function: GPU_Scale'); abort(-1);
  }

  function _GPU_SetDebugLevel() {
  err('missing function: GPU_SetDebugLevel'); abort(-1);
  }

  function _GPU_SetImageFilter() {
  err('missing function: GPU_SetImageFilter'); abort(-1);
  }

  function _GPU_SetInitWindow() {
  err('missing function: GPU_SetInitWindow'); abort(-1);
  }

  function _GPU_SetRequiredFeatures() {
  err('missing function: GPU_SetRequiredFeatures'); abort(-1);
  }

  function _GPU_SetUniformf() {
  err('missing function: GPU_SetUniformf'); abort(-1);
  }

  function _GPU_SetUniformfv() {
  err('missing function: GPU_SetUniformfv'); abort(-1);
  }

  function _GPU_SetWindowResolution() {
  err('missing function: GPU_SetWindowResolution'); abort(-1);
  }

  function _GPU_Translate() {
  err('missing function: GPU_Translate'); abort(-1);
  }

  function _GPU_Tri() {
  err('missing function: GPU_Tri'); abort(-1);
  }

  function _GPU_TriFilled() {
  err('missing function: GPU_TriFilled'); abort(-1);
  }
  ...
  function _luaL_checklstring() {
  err('missing function: luaL_checklstring'); abort(-1);
  }

  function _luaL_checknumber() {
  err('missing function: luaL_checknumber'); abort(-1);
  }

  function _luaL_loadfile() {
  err('missing function: luaL_loadfile'); abort(-1);
  }

  function _luaL_newstate() {
  err('missing function: luaL_newstate'); abort(-1);
  }

  function _luaL_openlibs() {
  err('missing function: luaL_openlibs'); abort(-1);
  }

  function _lua_call() {
  err('missing function: lua_call'); abort(-1);
  }

  function _lua_getfield() {
  err('missing function: lua_getfield'); abort(-1);
  }

  function _lua_gettable() {
  err('missing function: lua_gettable'); abort(-1);
  }

  function _lua_gettop() {
  err('missing function: lua_gettop'); abort(-1);
  }

  function _lua_isnumber() {
  err('missing function: lua_isnumber'); abort(-1);
  }

  function _lua_isstring() {
  err('missing function: lua_isstring'); abort(-1);
  }

  function _lua_pcall() {
  err('missing function: lua_pcall'); abort(-1);
  }

  function _lua_pushboolean() {
  err('missing function: lua_pushboolean'); abort(-1);
  }

  function _lua_pushcclosure() {
  err('missing function: lua_pushcclosure'); abort(-1);
  }

  function _lua_pushinteger() {
  err('missing function: lua_pushinteger'); abort(-1);
  }

  function _lua_pushnumber() {
  err('missing function: lua_pushnumber'); abort(-1);
  }

  function _lua_pushstring() {
  err('missing function: lua_pushstring'); abort(-1);
  }

  function _lua_pushvalue() {
  err('missing function: lua_pushvalue'); abort(-1);
  }

  function _lua_setfield() {
  err('missing function: lua_setfield'); abort(-1);
  }

  function _lua_settop() {
  err('missing function: lua_settop'); abort(-1);
  }

  function _lua_toboolean() {
  err('missing function: lua_toboolean'); abort(-1);
  }

  function _lua_tolstring() {
  err('missing function: lua_tolstring'); abort(-1);
  }

  function _lua_tonumber() {
  err('missing function: lua_tonumber'); abort(-1);
  }

  function _lua_type() {
  err('missing function: lua_type'); abort(-1);
  }
...
var real___GLOBAL__sub_I_tsab_cpp = asm["__GLOBAL__sub_I_tsab_cpp"]; asm["__GLOBAL__sub_I_tsab_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_tsab_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_tsab_cpp = Module["__GLOBAL__sub_I_tsab_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_tsab_cpp"].apply(null, arguments) };
